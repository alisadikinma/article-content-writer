# Article Generation Reference — Strategy + Outline (Steps 2-3, Phase B split)

System prompt reference for the `/article-strategy-outline` skill.
Contains: global-config, frameworks-library, hook-repository, emotional-arcs, content-templates.
Research-specific content (Layer 1-4 queries, Source Tier rules, data-point collection, entity extraction, written guide extraction) lives in refs-research.md — do NOT duplicate it here.
